...
fn test_wrapper() -> Result<(), ErrPack<TensorOpError>> {
	...
	/*	#[rustfmt::skip] let expected_d_inp = lit.new_2d(&[
		[-9.9944e-01, -5.8648e-03, -1.4330e+00,  6.3125e-01],
		[-2.7515e+00,  8.3601e+00,  4.5424e+00, -2.5466e-01],
		[ 1.5747e+00,  4.7638e-01,  1.8193e+00, -5.4652e-01],
		[ 3.0967e-01, -9.7247e-02, -2.2545e+00,  1.5950e-01],
		[ 1.5111e+00,  4.1603e-01, -2.5853e-01, -2.1302e-01]
	])?;
