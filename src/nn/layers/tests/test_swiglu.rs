...
fn test_swiglu() {
	...
	#[rustfmt::skip] let inp = Tensor::new_debug_3d(
		dev.clone(),
		debug_3d![
			f32;
			[
	...
	#[rustfmt::skip] let expected_d_inp = Tensor::new_debug_3d(
		dev.clone(),
		debug_3d![
			f32;
			[
				...
				[ 2.4876e-01,  3.6512e-02, -1.3431e+00, -3.0601e-02,
				  2.1467e-01,  3.1948e-01,  3.2169e-01]
			], [
				[-2.6249e-01, -1.7338e-02, -2.0617e-02,  4.2787e-01,
				 -3.4620e-01,  2.0948e-01,  5.3631e-02],
				[-9.9984e-02, -1.4431e-02, -7.9667e-02, -2.8202e-01,
				 -1.5872e-01,  1.4696e-02,  2.3797e-02]
			], [
				[ 3.8707e-01,  2.4786e-01,  1.7097e-01,  1.1204e-02,
				  2.5713e-01, -9.4806e-02, -1.2859e+00],
				[-9.6338e-02, -2.2842e-01,  5.4390e-01, -1.2849e-01,
				 -1.0244e-01, -1.2600e-01, -7.3325e-02]
			], [
				[ 3.7918e-01, -2.3067e-01,  3.6920e-02, -1.7191e-01,
				 -2.0889e-01, -8.9892e-01, -1.5648e+00],
				[-5.1002e-01, -3.6311e-01,  1.0426e-01, -3.7060e-01,
				 -4.4279e-02,  3.4640e+00, -1.6774e+00]
			],
		]
	);
